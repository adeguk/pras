            ...
            <div class="container-fluid">
                ...
                <div class="nav-collapse in collapse">
                    ...
                    <div class="nav pull-right" id="user-menu">
                        <div class="btn-group">
                            <a href="<?php echo base_url('/users/profile'); ?>" id="tb_email" class="btn dark" title="<?php echo lang('bf_user_settings'); ?>">
                            <?php
                                ...
                                <li>
                                    <div class="inner">
                                        ...
                                        <div class="toolbar-profile-info">
                                            ...
                                            <a href="<?php echo base_url('users/profile'); ?>"><?php echo lang('bf_user_settings'); ?></a>
