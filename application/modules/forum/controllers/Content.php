...
{
    protected $permissionCreate = 'Forum.Content.Create';
    protected $permissionDelete = 'Forum.Content.Delete';
    protected $permissionEdit   = 'Forum.Content.Edit';
    protected $permissionView   = 'Forum.Content.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_forum()) {
                ...
                redirect(SITE_AREA . '/content/forum');
            }
