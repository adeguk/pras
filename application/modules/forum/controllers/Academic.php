...
{
    protected $permissionCreate = 'Forum.Academic.Create';
    protected $permissionDelete = 'Forum.Academic.Delete';
    protected $permissionEdit   = 'Forum.Academic.Edit';
    protected $permissionView   = 'Forum.Academic.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_forum()) {
                ...
                redirect(SITE_AREA . '/academic/forum');
            }
