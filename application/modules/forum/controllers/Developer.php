...
{
    protected $permissionCreate = 'Forum.Developer.Create';
    protected $permissionDelete = 'Forum.Developer.Delete';
    protected $permissionEdit   = 'Forum.Developer.Edit';
    protected $permissionView   = 'Forum.Developer.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_forum()) {
                ...
                redirect(SITE_AREA . '/developer/forum');
            }
