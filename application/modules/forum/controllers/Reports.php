...
{
    protected $permissionCreate = 'Forum.Reports.Create';
    protected $permissionDelete = 'Forum.Reports.Delete';
    protected $permissionEdit   = 'Forum.Reports.Edit';
    protected $permissionView   = 'Forum.Reports.View';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_forum()) {
                ...
                redirect(SITE_AREA . '/reports/forum');
            }
