...
$num_columns	= 5;
$can_delete	= $this->auth->has_permission('Forum.Developer.Delete');
$can_edit		= $this->auth->has_permission('Forum.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/forum/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->field1); ?></td>
				<?php else : ?>
