...
<!--subject Code-->
	<div class="control-group <?php if (form_error('subjectCode')) echo 'error'; ?>">
		...
		<div class="controls">
			<input type="text" name="subjectCode" class="input-xxlarge" value="<?php echo set_value('subjectCode', isset($post) ? $post->subjectCode : ''); ?>" placeholder="Type Course Code here..." />
...
<!--subject Title-->
	<div class="control-group <?php if (form_error('subjectTitle')) echo 'error'; ?>">
		...
		<div class="controls">
			<input type="text" name="subjectTitle" class="input-xxlarge" value="<?php echo set_value('subjectTitle', isset($post) ? $post->subjectTitle : ''); ?>" placeholder="Type Course Title here..." />
	...
	<div class="control-group <?php if (form_error('instructor')) echo 'error'; ?>">
		...
		<div class="controls">
            <select name="instructor" class="input-xxlarge chzn-select">
                ...
                <?php editUser_byRole($post->instructor, 4); ?>
            </select>
...
<!--Status-->
	...
	<div class="form-actions">
		...
		or <a href="<?php echo site_url(SITE_AREA .'/academic/subject/') ?>">Cancel</a>
	</div>
</fieldset>
	<?php echo form_close(); ?>
</div>
