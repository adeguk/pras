...
class Settings extends Admin_Controller {
	...
	public function __construct() {
        ...
        #Assets::add_js($this->load->view('settings/datepicker_inline.js', null, true) , 'inline');
		...
		$this->load->model(array('roles/role_model', 'education_model', 'otherdata_model'));
	...
	public function create() {
		...
		Template::set_view('settings/create');
		Template::render();
	}//end create()
	...
	public function edit($user_id='')	{
		$this->load->config('address');
		$this->load->helper(array('address', 'date'));
    ...
    public function create_other_data($user_id='') {
        ...
        Template::set('toolbar_title', lang('us_edit_user'));
        Template::set_view('settings/create_other_data');
        Template::render();
    }
	...
	public function other_data($id='')	{
        ...
        Template::set_view('users/settings/other_data');
        Template::render();
	}//end profile: others()
