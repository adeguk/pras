<!--TODO: 
	1: complete the auto-sumation on this page -->
<style>
th.id { width: 3em; }
...
<div class="well shallow-well">
	...
	<!--TODO: 1: Auto-sumation -->
	<span class="filter-link-list" style='float:right'>Total User: <?php #echo $role_type == 'all' ? ' class="active"' : ''; ?></span>
</div>
	...
	<table class="table table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php $userRecord = $this->otherdata_model->find_by('user_id', $user->id);	
					if (!empty($userRecord))
						echo anchor(site_url(SITE_AREA . '/settings/users/other_data/' . $userRecord->otherD_id), 'Edit Other Details');
					else
						echo anchor(site_url(SITE_AREA . '/settings/users/create_other_data/'. $user->id), 'Create Other Details'); 
				?></td>
			</tr>
			<?php
				endforeach;
