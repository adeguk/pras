		...
		<div class="span9">
			...
			<!--religion-->
				<div class="control-group <?php echo iif( form_error('religion') , 'error') ;?>">
					...
					<div class="controls">
						<select name="religion" class="input-xxlarge chzn-select">
			...
			<!--marital status-->
				<div class="control-group <?php echo iif( form_error('marital_status') , 'error') ;?>">
					...
					<div class="controls">
						<select name="marital_status" class="input-xxlarge chzn-select">
			...
			<!--health status-->
				<div class="control-group <?php echo iif( form_error('health_status') , 'error') ;?>">
					...
					<div class="controls">
						<select name="health_status" class="input-xxlarge chzn-select">
