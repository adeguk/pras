<?php
    ...
    // For the settings form, $renderPayload should not be set to $current_user or $this->auth->user(),
    // as it can't be assumed that $current_user is the same as the user being edited.
    $renderPayload = null;
