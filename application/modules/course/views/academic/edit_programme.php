	...
	<div class="control-group <?php if (form_error('studyMode')) echo 'error'; ?>">
		...
		<div class="controls">
			<select name="studyMode" class="input-xxlarge chzn-select">
                <option value="0" >Please select the right Study type...</option>
