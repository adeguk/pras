...
<div class="admin-box">
    <h3><?php echo lang('pras_field_unit'); ?> Configuration and Management</h3>
            ...
            <tr>
                <th>
                    <div class="control" style="float:right;  margin-right: 5px;">
                        ...
                        placeholder="search department ..." title='or Search by program' />
    ...
    <table class="table table-striped table-hover table-bordered">
        <thead>
			<tr>
				...
				<th><?= lang('pras_field_minimum_unit'); ?></th>
				<th><?= lang('pras_field_maximum_unit'); ?></th>
        ...
        <?php if ($has_records) :
            foreach ($records as $record) :
                $duration = $durations[$record->progDuration];
                ...
                <td>
                    <?php echo anchor($areaUrl . 'editProgrammeUnit/' . $record->id, $edit_icon.$record->program." <strong>($duration)</strong>"); ?>
                </td>
                <?php elseif ($can_edit) : ?>
                <td>
                    <?php echo anchor($areaUrl . 'editProgrammeUnit/' . $record->id, $edit_icon.$record->program." <strong>($duration)</strong>"); ?>
                ...
                <?php else : ?>
                <td><?php e($record->program." <strong>($duration)</strong>"); ?></td>
                <?php endif; ?>


				<td><?php e($levels[$record->programmeLevel]); ?></td>
				<td><?php e($semesters[$record->sem_session_id]); ?>
				<td><?php e($units[$record->minimumUnit]); ?></td>
				<td><?php e($units[$record->maximumUnit]); ?></td>
				</td>
				<td>
