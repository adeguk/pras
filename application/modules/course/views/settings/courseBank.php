...
<div class="admin-box">
    <h3>List of <?php echo lang('pras_field_courseBank'); ?></h3>
    ...
    <table class="table table-striped table-hover table-bordered">
        ...
        <?php if ($has_records) :
            foreach ($records as $record) :
                ...
                if ($can_delete) : ?>
			    <td><input type="checkbox" name="checked[]" value="<?php echo $record->course_id ?>" /></td>
                <?php endif;
